...
class apiMySqlStorage {
  ...
  public function set($id, $value) {
   	$this->loadModule('AnalyticsAccount');
	$this->ApiStorage->save(array('AnalyticsAccount'=>array('id'=>$id,'tokens'=>$value)));
  }
  ...
  public function get($id) {
	$this->loadModule('AnalyticsAccount');
    $AccountData = $this->AnalyticsAccount->findById('AnalyticsAccount',array('fields'=>array('tokens')));
	if(array_key_exists('AnalyticsAccount',$AccountData)){
		return $AccountData['AnalyticsAccount']['tokens'];
	}else{
		return '';
	}
  }
  ...
  public function delete($id) {
	  $this->loadModule('AnalyticsAccount');
	  $this->ApiStorage->save(array('AnalyticsAccount'=>array('id'=>$id,'tokens'=>'')));
  }
}
